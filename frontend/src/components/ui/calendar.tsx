    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "flex items-center gap-1 rounded-(--cell-radius) border border-border bg-background px-2.5 py-1 text-sm font-semibold [&>svg]:size-3.5 [&>svg]:text-muted-foreground",
        ...
        today: cn(
          "bg-accent text-accent-foreground data-[selected=true]:bg-transparent",
      ...
      components={{
        Root: ({ className, rootRef, ...props }: { className?: string; rootRef?: React.Ref<HTMLDivElement> }) => {
          return (
            <div
              data-slot="calendar"
              ref={rootRef}
